...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='w-full bg-brown md:flex md:justify-start md:items-center sticky top-0 shadow-md z-10'>
        ...
        <IoCartOutline onClick={toggleCart} className='text-3xl text-white font-bold mx-5 cursor-pointer absolute top-8 right-4 md:top-5 ' />
        <div ref={ref} className="sideCart border-brown border-2 absolute top-0 right-0 bg-white py-10 px-8 w-72 h-[100vh] transition-transform translate-x-full">
          ...
          <ol className='list-decimal'>
            <li>
              <div className="item flex my-5">
                <div className='w-2/3 font-semibold'>Trekking pants sustainable</div>
                <div className='w-1/3 flex items-center font-semibold text-lg justify-center'><AiFillMinusCircle className='cursor-pointer text-brown'/> <span className='mx-2 text-sm'>1</span><AiFillPlusCircle className='cursor-pointer text-brown'/></div>
              </div>
            </li>
            <li>
              <div className="item flex my-5">
          ...
          <button className="flex items-center mt-5 text-white bg-brown-light border-0 py-2 px-2 focus:outline-none hover:bg-brown rounded text-sm"><IoBagCheck className='m-1'/> <span>Checkout </span> </button>
          <button className="flex mt-5 text-white bg-brown-light border-0 py-2 px-4 text-md focus:outline-none hover:bg-brown rounded text-sm">Clear Cart</button>
          </div>
        </div>
      </nav>
      <div className={`md:pt-0 ${isopen ? 'transition-all  pt-[220px]' : 'pt-[10px]'}`}>
      </div>
    </>
  )
}
